...
// if it is a number append it to the text view.
//if (Double(input) != nil){
//    //            if (resultReturned == true) { self.calcTextField.text = ""; resultReturned = false; input1 = 0}
//    self.calcTextField.text = self.calcTextField.text + input
//    needsSecondinput = false
//}

//// if it is an operation.. perform the operation.
//if (Double(input) == nil && nextShouldBeNumber == false) {
//    if (input == "C"){
//        clearCalc()
//    }else if (input == "."){
//        self.calcTextField.text = self.calcTextField.text + "."
//    }else else if (input == "="){
//        self.calcTextField.text = String(calc.getValue())
//    }else{
//        if (input1 == 0){
//            input1 = Double(self.calcTextField.text)!
//            self.calcTextField.text = ""
//        }
//        else {
//            if (needsSecondinput == false){
//                input2 = Double(self.calcTextField.text)!
//                if (input == "="){
//                    input1 = Double(calc.inputInterpretation(prevOp, input1: input1, input2: input2))!
//                }else{
//                    input1 = Double(calc.inputInterpretation(input, input1: input1, input2: input2))!
//                }
//                resultReturned = true
//                needsSecondinput = true
//                self.calcTextField.text = String(input1)
//            }
//        }
//    }
//}